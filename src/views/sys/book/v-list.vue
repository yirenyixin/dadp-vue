          ...
          <el-row :gutter="12">
            ...
            <el-col :span="8">
              <el-form-item label="创建时间" prop="createTime">
                <el-input v-model="queryParams.createTime" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="发布者Id" prop="roleId">
                <el-input v-model="queryParams.roleId" clearable></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="12">
            ...
            <el-col :span="8">
              <el-form-item label="作者" prop="author">
                <el-input v-model="queryParams.author" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="发布者" prop="role">
                <el-input v-model="queryParams.role" clearable></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
        ...
        <template #table-column-end>
          <el-table-column fixed="right" label="操作" width="100">
            <template #default="scope">
              <el-button type="text" @click.stop="editBook(scope.row)"
...
import { RowType, bookTableColumns } from './book-hook';
  ...
  setup() {
    ...
    const methodsMap = reactive({
      ...
      doQuery: async (doInit = false) => {
        ...
        const { data: res } = await sysApi.getBookList(params);
